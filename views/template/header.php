...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
      <img class="animation__shake" src="public/logo_tgs.png" alt="AdminLTELogo" height="100" width="150">
    </div>
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="changepassword" class="nav-link">แก้ไขรหัสผ่าน</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <a id="getlogout" href="#" class="nav-link">ออกจากระบบ</a>
        </li>
      </ul>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="dashboard" class="brand-link">
        ...
        <img src="public/logo_tgs.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">TGS</span>
      </a>
