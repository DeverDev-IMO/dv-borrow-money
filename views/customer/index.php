      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">ข้อมูลลูกค้าข้อมูลลูกค้า</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
      <div class="card card-primary card-outline">
        <div class="card-header">
          <div class="row">
            <div class="col-md-6">
              <h3 class="card-title mt-2">รายการข้อมูลลูกค้า</h3>
            </div>
        ...
        <div class="card-body">
          ...
          <table class="table table-hover projects mt-3 reloadcustomer">
            <thead>
              <tr>
                <th style="width: 2%"> #</th>
                <th>ชื่อ-สกุล</th>
            ...
            <tbody>
              <?php $i = 1;
              foreach ($customer->listClient("users") as $client) : ?>
                <tr>
                  <td><?php echo $i; ?></td>
