...
$head = '
    ...
    <div style="border: 0px solid black;padding-top:20px;padding-left: 10px;">
        <table style="width:100%;margin-top:5px;" cellpadding=0 cellspacing=0 border="0">
            <tr>
                <td style="width:10%;text-align:left;" rowspan="3">
                    <img width=110 height=75 src="../../public/logo_tgs.png">
                </td>
                <td style="width:60%;text-align:left;font-size:22px;"><b>เลขที่การ์ด&emsp;&emsp;' . $client['contract_number'] . '</b></td>
                <td></td>
            </tr>
            <tr>
                <td style="width:60%;text-align:left;font-size:22px;"><b>ชื่อลูกค้า&emsp;&emsp;&emsp;' . $client['setpre_name'] . $client['cus_firstname'] . ' ' . $client['cus_lastname'] . '</b></td>
                <td></td>
            </tr>
        </table>
    </div>
...
$content = '
  <div style="padding:5px;margin-top:200px;padding-left:0px;">
    <table style="width:100%;margin-top:5px;" cellpadding=0 cellspacing=0 border="0">
        <tr>
