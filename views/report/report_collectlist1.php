...
foreach ($report->listreportcollectClient("contract", $date_start, $date_end) as $client) :
    $content .= '
          <tr style="border: 1px solid black;">
            ...
            <td style="padding:6px;font-size:13px;" align="right">' . number_format($client['paysum_pay_amount']) . '</td>
            <td style="padding:6px;font-size:13px;" align="right">' . number_format($client['cash_installments_daily']) . '</td>
            <td style="padding:6px;font-size:13px;" align="right">' . number_format($client['paysum_pay_balance']) . '</td>
