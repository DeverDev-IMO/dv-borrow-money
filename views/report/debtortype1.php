  ...
  <table style="width:100%;margin-top:5px;" cellpadding=0 cellspacing=0 border="0">
      <tr>
          <td style="width:40%;text-align:left;">
              <span style="border-bottom:2px;font-size:16px;"><b>รายงานลูกหนี้มียอดค้างชำระ ระหว่าง 1 ถึง 10 งวด</b> </span>
          </td>
...
foreach ($report->listreportDebtorType1("contract", $date_start, $date_end) as $client) :
